  ...
  return (
   ...
   <div className='min-w-96 absolute top-1/3 left-1/3'>
    ...
    <form onSubmit={handleSubmit} className='flex flex-col items-center justify-center space-y-2'>
       ...
       <label htmlFor='username' className='label pb-4'>
        ...
        <div className='w-full'>
         ...
         <button type="submit" className='w-full rounded-md bg-blue-600 text-white my-4 h-10 hover:bg-blue-700'>Sign Up</button> 
